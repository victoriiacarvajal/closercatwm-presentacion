...
export default function ConversationSimulator() {
  const [step, setStep] = useState<'simulator' | 'multimedia' | 'volume' | 'form' | 'results'>('simulator');
      ...
      <div className="space-y-4">
        <div className="flex gap-2 mb-2">
          <button
            ...
            className={`flex-1 py-2 px-4 rounded-lg font-poppins font-semibold text-sm transition-all ${
