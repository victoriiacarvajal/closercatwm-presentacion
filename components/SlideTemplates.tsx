...
// 13. Pricing Logic Slide
export const PricingLogicSlide: React.FC<TemplateProps> = ({ data }) => {
            ...
            <div className="space-y-4 pt-2">
              {bullets.map((bullet, idx) => (
                <div key={idx} className="flex items-start bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                  <span className="text-xl mr-3 mt-1 select-none text-purple-600">{bullet.split(':')[0].trim()}</span>
                  <div>
